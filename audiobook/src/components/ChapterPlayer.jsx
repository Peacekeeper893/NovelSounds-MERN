...
const Chapter = ({ title, url, openModalHandler, openModal, book , chapter_number ,sendData }) => {
    ...
    return (
        <Fragment>
            ...
            <div className={`${openModal && "bg-transparent bottom-0 text-2xl md:text-4xl"} ${!openModal && "bg-gradient-to-r from-stone-200 via-stone-200 to-stone-400 text-xl dark:bg-gradient-to-tr dark:from-neutral-700 dark:via-violet-500 dark:to-slate-400"}    rounded-t-3xl`}>
